...
},{"./actions":16,"./ui":19,"./util/app":20,"iblokz/adapters/vdom":1,"iblokz/common/arr":2,"iblokz/common/obj":3,"rx":5}],18:[function(require,module,exports){
'use strict';
...
module.exports = function (_ref) {
	var state = _ref.state,
	    actions = _ref.actions;
	return section('#ui', [h1('xAmp Prototype')]);
};
