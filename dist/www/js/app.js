...
(function (global, factory) {
  ...
  var cross = function cross(a, b, f) {
    var na = a.length,
        nb = b.length,
        c = new Array(na * nb),
        ia,
...
var processAttrs = function processAttrs(args) {
	...
	attrs = attrs && attrs.map && attrs.map(function (c) {
		...
		return obj.patch(o, attr[0], attr[1]);
	}, {}) || {};
...
var hyperHelpers = ['h1', 'h2', 'h3', 'h4', 'section', 'header', 'article', 'div', 'p', 'span', 'pre', 'code', 'a', 'dd', 'dt', 'hr', 'br', 'b', 'i', 'table', 'thead', 'tbody', 'th', 'tr', 'td', 'ul', 'ol', 'li', 'form', 'fieldset', 'legend', 'input', 'textarea', 'label', 'button', 'select', 'option', 'canvas', 'video', 'img'].reduce(function (o, tag) {
	o[tag] = function () {
		var _this = this;
...
},{"../common/obj":4,"snabbdom":15,"snabbdom/h":7,"snabbdom/modules/attributes":10,"snabbdom/modules/class":11,"snabbdom/modules/eventlisteners":12,"snabbdom/modules/props":13,"snabbdom/modules/style":14}],3:[function(require,module,exports){
'use strict';
...
var sub = function sub(o, p) {
	return p instanceof Array && o[p[0]] && sub(o[p[0]], p.slice(1)) || o[p] || false;
};

var patch = function patch(o, k, v) {
	return _extends(clone(o), k instanceof Array ? keyValue(k[0], k.length > 1 ? patch(o[k[0]] || {}, k.slice(1), v) : _typeof(o[k[0]]) === 'object' && _extends(clone(o[k[0]]), v) || v) : keyValue(k, _typeof(o[k]) === 'object' && _extends(clone(o[k]), v) || v));
};

var map = function map(o, cb) {
	return Object.keys(o).reduce(function (o2, k, i) {
		return o2[k] = cb(o[k], k, i), o2;
	}, {});
};
...
var set = function set(number) {
	return function (state) {
		return _extends({}, state, { number: number });
	};
};
...
var arr = require('iblokz/common/arr');
...
var initd3 = function initd3() {
	var dataTsv = "https://gist.githubusercontent.com/alex-milanov/eabaa766034d1094309f41994164f515/raw/26538cbd3afe46554d8f0fff24d2bd782e9bd017/data.tsv";
	console.log(123);
	...
	d3.tsv(dataTsv, function (d) {
		return _extends({}, d, { frequency: Number(d.frequency) });
	}, function (error, data) {
...
state$.take(1).delay(100).subscribe(function () {
	return initd3();
});
...
},{"./actions":17,"./ui":20,"./util/app":21,"d3":1,"iblokz/adapters/vdom":2,"iblokz/common/arr":3,"iblokz/common/obj":4,"rx":6}],19:[function(require,module,exports){
'use strict';
...
module.exports = function (_ref) {
	...
	return section('.counter', [button({ on: { click: function click() {
				return actions.decr();
			} } }, 'Decrease'), span('Number:'), span('[contenteditable="true"]', {
		on: { input: function input(ev) {
				return actions.set(parseInt(ev.target.textContent, 10));
			} }
	}, state.number), button({ on: { click: function click() {
				return actions.incr();
			} } }, 'Increase')]);
};

},{"iblokz/adapters/vdom":2}],20:[function(require,module,exports){
'use strict';
...
module.exports = function (_ref) {
	var state = _ref.state,
	    actions = _ref.actions;
	return section('.app', [h1('xAmp Prototype'), h('audio#song', { attrs: { src: 'assets/LatinEthnoElektroGroove.mp3', controls: true } }), h('svg', { attrs: { width: 640, height: 240 } })]);
};

},{"./counter":19,"iblokz/adapters/vdom":2}],21:[function(require,module,exports){
'use strict';
...
var adapt = function adapt(o) {
	return Object.keys(o).filter(function (key) {
		...
		return _extends({}, o2, o[key] instanceof Function && obj.keyValue(key, function () {
			var resp = o[key].apply(null, arr.fromList(arguments));
...
},{"iblokz/common/arr":3,"iblokz/common/obj":4,"rx":6}]},{},[18]);
